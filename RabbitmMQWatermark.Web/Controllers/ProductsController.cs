...
namespace RabbitmMQWatermark.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Stock,Price,PictureUrl")] Product product, IFormFile ImageFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Stock,Price,PictureUrl")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
